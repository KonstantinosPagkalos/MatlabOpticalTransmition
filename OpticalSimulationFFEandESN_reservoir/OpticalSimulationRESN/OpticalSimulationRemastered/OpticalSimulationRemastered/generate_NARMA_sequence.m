function [inputSequence, outputSequence] = generate_NARMA_sequence()
...
% memoryLength: a natural number indicating thea dependency length
%
% outputs: 
